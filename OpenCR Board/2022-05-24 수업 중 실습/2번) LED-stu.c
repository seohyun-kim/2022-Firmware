...
void MyApp()
{
	...
	while(1){
		TurnOnOneInsideLEDwith4GPIO(1, 1);
		TurnOnOneInsideLEDwith4GPIO(2, 1);
		TurnOnOneInsideLEDwith4GPIO(3, 1);
		TurnOnOneInsideLEDwith4GPIO(4, 1);
	}
...
void TurnOnOneInsideLEDwith4GPIO(UINT32 InsideNo, UINT32 Duration){
	...
	*((V_UINT32*)(getBaseAddrforOutLED(InsideNo)+BSRROFFSET))  |= (SETRESET << getPortforOutLED(InsideNo));
