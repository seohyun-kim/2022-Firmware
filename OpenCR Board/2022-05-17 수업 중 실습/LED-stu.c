...
void MyApp()
{
	...
	// BSRR reset
	*((V_UINT32*)(GPIOG_BASEADDRESS+BSRROFFSET))  |= (SETRESET << (7+16)); //reset
	*((V_UINT32*)(GPIOG_BASEADDRESS+BSRROFFSET))  |= (SETRESET << (6+16)); //reset

	// BSRR set
	*((V_UINT32*)(GPIOC_BASEADDRESS+BSRROFFSET))  |= (SETRESET << 1); //set
}
